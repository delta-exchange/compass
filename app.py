...
scheduler.add_job(CompassGenerator.start, CronTrigger(hour="2", minute="0"), kwargs={"date": None})
scheduler.add_job(ReportsCleaner.clean_older_reports, CronTrigger(hour="2", minute="0"))
