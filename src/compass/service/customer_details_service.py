from src.database.service import UserDetailsService, KycDocumentsService, LoginHistoryService, CorporateAccountDetailsService
...
class CustomerDetailsService:
    ...
    @staticmethod
    def convert_to_compass_format(users, users_mapping, user_kyc_details_mapping, login_city_list, corporate_accounts_mapping):
        users_compass = []
        for user in users:
            ...
            if not main_user.corporate_account_id == nil:
                ...
                users_compass.append(user_data)
            else:     
