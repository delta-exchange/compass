...
class CompassGenerator:
    ...
    def start():
        try:
            from_time = DateTimeUtil.get_24hrs_ago()
            ...
            # LinkedAccountDetailsService.generate_linked_account_details(from_time)
            # CustomerLoginDetailsService.generate_customer_login_details(from_time)
            # ExchangeDetailsService.generate_exchange_details()
            # CustomerDetailsService.generate_customer_details_details(from_time)
            ...
            TransactionDetailsService.generate_transaction_details(from_time)
            # ProductDetailsService.generate_product_details(from_time)
